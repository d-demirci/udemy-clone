...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', default='guacozy_db'),
        'USER': os.environ.get('DB_USER', default='guacozy_db_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD',default='guacozy_db_password'),
